...
""")
    ...
    def test_insert_idml(self):
        ...
        self.assertEqual([(elt.tag, dict(elt.attrib)) for elt in main_idml_file.spreads_objects[0].dom.iter()], [
...
""")
    ...
    def test_insert_idml_with_complex_source(self):
        ...
        #pp.pprint([(elt.tag, dict(elt.attrib)) for elt in main_idml_file.spreads_objects[0].dom.iter()])
        self.assertEqual([(elt.tag, dict(elt.attrib)) for elt in main_idml_file.spreads_objects[0].dom.iter()], [
            ('{http://ns.adobe.com/AdobeInDesign/idml/1.0/packaging}Spread',
             {'DOMVersion': '7.5'}),
            ('Spread',
